...
### Repay Loan
#### High-Level Implementation
Repaying loan validation will be similar to grabbing a loan. We will construct a ValidateRepayInfo from the input collateral UTxOs and output interest UTxOs. 
```
